                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="{{ route('page.create') }}" class="btn btn-sm btn-success px-4 py-2">Create</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                            ...
                                            <tbody>
                                                @forelse ($pages as $page)
                                                    <tr class="{{ $loop->iteration % 2 == 0 ? 'even' : 'odd' }}">
                                                        <td class="dtr-control sorting_1" tabindex="0">{{ $page->options }}</td>
                                                        <td class="dtr-control sorting_1" tabindex="0">{{ $page->key }}</td>
                                                        <td class="dtr-control sorting_1 third-column" tabindex="0">{!! html_entity_decode($page->value) !!}</td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="{{ route('page.edit', $page->id) }}" class="btn btn-sm btn-success mx-2">Edit</a>
                                                                {!! Form::open(['url' => route("page.destroy",$page->id)]) !!}
