...
<section class="content">
            ...
            {!! Form::open(['url' => route("page.update",$page->id),'method' => 'post']) !!}
              <div class="card-body">
                <div class="form-group">
                  <label>Options</label>
                  <input type="text" class="form-control" name="options" placeholder="options..." value="{{ old('options',$page->options) }}">
                  @error('options')
                ...
                <div class="form-group">
                  <label>Key</label>
                  <input type="text" class="form-control" name="key" placeholder="key..." value="{{ old('key',$page->key) }}">
                  @error('key')
                    <span class="text-danger py-20">{{ $message }}</span>
                  @enderror
                </div>
                <div class="form-group">
                  <label>Value</label>
                  <textarea class="form-control" id="editor"  placeholder="Enter the Description" rows="5" name="value">{!! html_entity_decode($page->value) !!}</textarea>
                  {{-- <input type="text" class="form-control" name="value" placeholder="value..." value="{{ old('value',$page->value) }}"> --}}
                  @error('value')
                    <span class="text-danger py-20">{{ $message }}</span>
                  @enderror
                </div>
  ...
  <!-- /.content -->
    ...
    <script>
        ...
        //         e.preventDefault();
        //         // $(this).each(function() {
        //         let cloneDiv = $(this).closest('form').find('.card-body').first();
