                                            ...
                                            <tbody>
                                                @forelse ($sections as $section)
                                                    <tr class="{{ $loop->iteration % 2 == 0 ? 'even' : 'odd' }}">
                                                        <td class="dtr-control sorting_1" tabindex="0">{{ $section->pages[0]->name }}</td>
                                                        <td class="dtr-control sorting_1" tabindex="0">{{ $section->section_name }}</td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="{{ route('section.edit', $section->id) }}"
                                                                    class="btn btn-sm btn-success mx-2">Edit</a>
                                                                {!! Form::open(['url' => route("section.destroy",$section->id)]) !!}
