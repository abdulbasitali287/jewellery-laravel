                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="{{ route('permission.create') }}" class="btn btn-sm btn-success px-4 py-2">Create</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                            ...
                                            <tbody>
                                                @forelse ($permissions as $permission)
                                                    <tr class="{{ $loop->iteration % 2 == 0 ? 'even' : 'odd' }}">
                                                        <td class="dtr-control sorting_1" tabindex="0">{{ $permission->name }}</td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="{{ route('permission.edit',$permission->id) }}" class="btn btn-sm btn-success mx-2">Edit</a>
                                                                {!! Form::open(['url' => route('permission.destroy',$permission->id)]) !!}
                                                                <button type="submit"
