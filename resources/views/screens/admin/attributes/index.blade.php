                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="{{ route('attribute.create') }}" class="btn btn-sm btn-success px-4 py-2">Create</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="example1"
                                            ...
                                            <tbody>
                                                @forelse ($attribute as $attributes)
                                                    <tr class="{{ $loop->iteration % 2 == 0 ? 'even' : 'odd' }}">
                                                        <td class="dtr-control sorting_1" tabindex="0">{{ $attributes->name }}</td>
                                                        <td class="dtr-control sorting_1" tabindex="0">
                                                            @foreach ($attributes->variants as $variants)
                                                                {{ $loop->iteration . ") " . $variants->name }}
                                                            @endforeach
                                                        </td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="{{ route('attribute.edit',$attributes->id) }}" class="btn btn-sm btn-success mx-2">Edit</a>
                                                                {!! Form::open(['url' => url('admin/attribute/destroy/') . '/' . $attributes->id]) !!}
                                                                <button type="submit"
