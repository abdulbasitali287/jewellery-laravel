                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="{{ route('hotel-bathrooms.create') }}" class="btn btn-sm btn-success px-2">Create</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="example1"
                                            ...
                                            <tbody>
                                                @forelse ($hotelBathrooms as $hotelBathroom)
                                                    <tr class="{{ $loop->iteration % 2 == 0 ? 'even' : 'odd' }}">
                                                        <td class="dtr-control sorting_1" tabindex="0">{{ $hotelBathroom->bathroom_type }}</td><td>
                                                            <div class="d-flex">
                                                                <a href="{{ route('hotel-bathrooms.edit', $hotelBathroom->id) }}" class="btn btn-sm btn-success mx-2">Edit</a>
                                                                <form action="{{ route('hotel-bathrooms.destroy',$hotelBathroom->id) }}" method="post">
                                                                    @csrf
                                                                    @method('DELETE')
