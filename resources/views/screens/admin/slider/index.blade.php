                                            ...
                                            <tbody>
                                                @forelse ($sliders as $slider)
                                                    <tr class="{{ $loop->iteration % 2 == 0 ? 'even' : 'odd' }}">
                                                        <td class="dtr-control sorting_1" tabindex="0">{{ $slider->title }}
                                                        </td>
                                                        <td>{{ $slider->sub_title }}</td>
                                                        <td>
                                                            {{-- @dd($slider->registerMediaCollections()) --}}
                                                            <img src="{{ $slider->getFirstMediaUrl('slider-media') }}" width="100px" alt="">
                                                            {{--@if ($images->isNoEmpty())
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                {!! Form::open(['url' => route('slider.destroy',$slider->id) ]) !!}
                                                                @method('DELETE')
