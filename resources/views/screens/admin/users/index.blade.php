                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            {{-- <a href="{{ route('role.create') }}" class="btn btn-sm btn-success px-4 py-2">Create</a> --}}
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                            ...
                                            <tbody>
                                                @forelse ($users as $user)
                                                    <tr class="{{ $loop->iteration % 2 == 0 ? 'even' : 'odd' }}">
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                {{-- <a href="{{ route('users.edit',$user->id) }}" class="btn btn-sm btn-success mx-2">Edit</a> --}}
                                                                <a href="{{ route('users.assign.role',$user->id) }}" class="btn btn-sm btn-primary mx-2">Assign/Edit Role</a>
