                                ...
                                <form action="{{ route('shipping.address.update') }}" method="POST">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="billing-address-fields">
                                            ...
                                            <input class="billing-detail-input" type="text" value="{{ old('name',auth()->user()->name) }}" name="name" id="">
                                            @error('name')
                                        ...
                                        <div class="billing-address-fields">
                                            ...
                                            <input class="billing-detail-input" type="text" value="{{ old('city',auth()->user()->city) }}" name="city" id="">
                                            @error('city')
                                            <span class="text-danger py-2 fs-4">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="billing-address-fields">
                                            ...
                                            <input class="billing-detail-input" type="text" value="{{ old('state',auth()->user()->state) }}" name="state" id="">
